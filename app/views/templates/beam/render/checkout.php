...
<body data-storecode="<?= $storecode ?>">
    ...
    <div class="checkout-container">
        ...
        <div class="checkout-content">
            <!-- CHECKOUT FORM -->
            <form class="checkout-form" id="checkoutForm" method="POST" action="<?= ROOT ?><?= $storecode ?>/checkout" onsubmit="handleSubmit(event)">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row full">
                        <div class="form-group">
                            ...
                            <input type="text" id="address2" name="address2" placeholder="Apartment, suite, floor, etc.">
                        </div>
                    </div>
                ...
                <div style="display: flex; gap: 1rem; margin-top: 2rem;">
                    <a href="/cart" style="flex: 1; padding: 1rem; border: 2px solid var(--border-color); border-radius: 8px; text-align: center; text-decoration: none; color: var(--text-dark); font-weight: 600; transition: var(--transition);" onmouseover="this.style.borderColor='var(--primary-blue)'" onmouseout="this.style.borderColor='var(--border-color)'">
                        <i class="fas fa-arrow-left"></i> Back to Cart
                    </a>
                    <button type="submit" class="place-order-btn" style="flex: 1;">
