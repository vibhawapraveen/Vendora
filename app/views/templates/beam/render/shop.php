...
<head>
    ...
    <title>Shop - <?= $content['title'] ?></title>
...
<body data-storeid="<?= htmlspecialchars($store['id'] ?? '') ?>">
    ...
    <section class="shop-header">
        <div class="shop-header-content">
            ...
            <p class="shop-subtitle">Browse our complete collection of quality products</p>
    ...
    <!-- SEARCH & CONTROLS -->
    <form method="GET" class="shop-controls" id="filterForm">
    ...
    <div class="shop-grid-container">
        <?php if (!empty($products)): ?>
            <div class="shop-grid">
                ...
                ?>
                    <div class="shop-product-card" onclick="viewProduct('<?= htmlspecialchars($product['id']) ?>')">
                        ...
                        <div class="shop-product-content">
                            <h3 class="shop-product-name"><?= htmlspecialchars($product['name']) ?></h3>
                            <div class="shop-product-price">
                                <?php if ($productPrice > 0): ?>
                                    $ <?= number_format($productPrice, 2) ?>
                                    <?php if (!empty($product['is_variant'])): ?>
                                        <span style="font-size: 0.8rem; color: var(--text-light); font-weight: 400;">from</span>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <span style="color: var(--text-light); font-size: 0.9rem;">Price on Request</span>
                                <?php endif; ?>
                            </div>
                            <div class="shop-product-actions">
                                <button class="view-product-btn-shop" onclick="viewProduct('<?= htmlspecialchars($product['id']) ?>'); event.stopPropagation();">
