...
<body>
        ...
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 1rem 2rem;">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    <h1 class="text-2xl font-bold" style="color: <?=$primary_color ?>;">
    ...
    <!-- Hero Section -->
    <section class="hero" style="background: linear-gradient(135deg, <?=$primary_color ?>, var(--accent)); padding: 4rem 0; color: white;">
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 2rem;">
            <div class="text-center">
                ...
                <button class="btn btn-lg" style="background: white; color: <?=$primary_color ?>; border: none; padding: 0.75rem 2rem;">
                    Shop Now
                </button>
            </div>
        </div>
